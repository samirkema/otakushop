...
*   Gestion hiérarchique des droits permettant à un administrateur de générer de nouveaux profils administrateurs.
...
*   Mise en place d'un protocole de connexion administrateur spécifique utilisant le format "mailenentier_admin", applicable uniquement aux utilisateurs bénéficiant déjà d'un compte validé avec des droits d'administration.
